<template>
  <div id="vue-app">
    <router-view />
    <CodeEditor
      v-model:visible="codeEditorStore.isVisible"
      :title="codeEditorStore.editorTitle"
      :code="codeEditorStore.editorCode"
      :language="codeEditorStore.editorLanguage"
      @save="codeEditorStore.saveCode"
    />
    <ProgressSpinner
      v-if="isLoading"
